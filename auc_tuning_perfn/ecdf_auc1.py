...
configurations = [
                  ...
                  #[5, 30, 4.3751, True, 'arctan'],[7, 31, 4.0938, False, 'gaussian'],
                  #deceptivepath
...
def main():
    ...
    for name in names:
        ...
        func1 = ioh.get_problem(fname[3:]+"_ng", iid=0, dim=dimension)  #instance 1
        func2 = ioh.get_problem(fname[3:]+"_ng", iid=0, dim=dimension)  #instance 2
        ...
        for config in configurations:    #configurations: list of lists
            ...
            lc = logger.Analyzer(root=r"tune_final1_"+str(budget)+"/data_"+name, folder_name=folder+algo1, algorithm_name=algo1)
                        
            func1.attach_logger(lc) #func instance 1, dcma

            lp = logger.Analyzer(root=r"tune_final1_"+str(budget)+"/data_"+name, folder_name=folder+algo2, algorithm_name=algo2)
                        
            func2.attach_logger(lp)  #func instance 2, pso
